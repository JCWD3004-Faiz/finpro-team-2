...
const Products: React.FC = () => {
  ...
  // State for managing category, search query and filtered products
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col items-center">
      ...
      {/* Main Content of Products Page */}
      <div className="w-full grid grid-cols-4 gap-x-8 gap-y-6 my-[15vh] p-4 justify-items-center items-center">
