...
const sidebarItems: SidebarItem[] = [
  { icon: ShoppingCart, label: 'New Transaction', href: '/cashier' },
  { icon: Clock, label: 'Current Shift', href: '/cashier/shift' },
  { icon: History, label: 'Transaction History', href: '/cashier/history' },
];
      ...
      >
        <div className="h-full px-4 py-6 overflow-y-auto bg-white border-r">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-xl font-semibold">Cashier Panel</h2>
            <button 
              onClick={() => setIsSidebarOpen(false)}
